...
void print_usage(const char* prog_name) {
    cout << "Usage: " << prog_name << " <aiger1> <aiger2> [num_patterns]" << endl;
    cout << "Options:" << endl;
    cout << "  -h, --help        Show this help message" << endl;
    cout << "  num_patterns      (Optional) Number of simulation patterns (default: 15000)" << endl;
    cout << "Example:" << endl;
    cout << "  " << prog_name << " circuit1.aig circuit2.aig 10000" << endl;
}
...
int main(int argc, char **argv)
{
    ...
    if (res == 0){
        ...
        std::cout << "Node size(and & not): " << x_data.size() << std::endl;
        std::cout << "Edge size: " << edge_index.size() << std::endl;
    }
    else{
